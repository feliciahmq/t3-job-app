  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Organize your job search, track applications, and never miss a follow-up with our intuitive job
                    application tracker.
                  </p>
                </div>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-muted bg-[#F7F9FC]">
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground">© 2025 JobTracker. All rights reserved.</p>
